                ...
                <div className='row'>
                    <div className='col-12'>
                        <div class="card mt-4">
                            ...
                            <a href={item.book.url} class="btn btn-primary btn-sm float-left text-color-primary justify-content-end">
                                Open
                            </a>
                            </div>
                            </div>
                                    ...
                                    <div className='col-md-10'>
                                        <div className='card-body row'>
                                            ...
                                            <div className='col-12 col-lg-6 d-flex flex-column flex-sm-row flex align-items-center justify-content-end'>
                                                <Link to={`/mentor/classroom/sesi-kursus/sesi-kursus-id/${item.id}/${item.id}`} className='btn btn-primary btn-sm block-in-mobile mx-sm-1 mb-2 mb-sm-0'>Masuk</Link>
                                            </div>
                                        </div>
                                    </div>
                                </div>
