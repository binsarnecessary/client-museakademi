  ...
  return (
    <>
      ...
      <div className="container" style={{ marginBottom: "2rem" }}>
        <button
          className={`btn-custom ${activeButton === "semua" ? "active" : ""}`}
        ...
        <button
          className={`btn-custom ${
            activeButton === "menunggu pembayaran" ? "active" : ""
          }`}
        ...
        <button
          className={`btn-custom ${
            activeButton === "menunggu konfirmasi" ? "active" : ""
          }`}
          onClick={() => handleFilter("menunggu konfirmasi")}
        >
          Menunggu Konfirmasi
        </button>
        <button
          className={`btn-custom ${activeButton === "selesai" ? "active" : ""}`}
        ...
        <button
          className={`btn-custom ${
            activeButton === "tidak valid" ? "active" : ""
          }`}
          onClick={() => handleFilter("tidak valid")}
        >
          Tidak Valid
        </button>
      </div>
              ...
              <div class="row no-gutters align-items-center">
                ...
                <div class="col-12 col-md-9">
                  <div class="card-body d-md-flex align-items-center justify-content-between">
                    <div>
                      <h6 class="card-title text-truncate w-100">
                        {item.judul}
                      </h6>
                      <div class="d-flex align-items-center mb-2">
                        <span class="mx-2 small">{item.invoice}</span>
                      </div>
                      <div class="mb-2">{`Rp. ${item.price}`}</div>
                      <div>
                        <span
                          class={`badge ${
