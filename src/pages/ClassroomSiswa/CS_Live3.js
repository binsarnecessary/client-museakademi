    ...
    <div className='container-fluid  mt-3'>
        ...
        <Image src={profil} className="rounded-circle"
                  ...
                  <div className='container-fluid col-3 mt-3'>
                    ...
                    <div type="submit" class="btn btn-danger btn-block btn-lg" fdprocessedid="ntqaw">Join Live Class</div>
                  </div>
            <div className='row mt-lg-3'>
                ...
                <div className='mt-3 col-12 col-lg-8 order-lg-1'>
                    <button className='btn btn-primary btn-block btn-lg'>Information</button>
