...
export const Livestreaming = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        const currentLivestreamingRequest = await axios.get(
          "https://server-museakademi-production-456b.up.railway.app/api/livestreaming"
        );
  ...
  const filteredProducts = livestreaming.filter((livestreaming) => {
    const eventStart = new Date(livestreaming.liveStart);
    ...
    <>
      ...
      <div className="container my-5 ">
        ...
        <div class="row">
          ...
          <div className="col">
            <div className="row">
              {filteredProducts.map((livestreaming) => (
                <LiveCard key={livestreaming.id} LiveData={livestreaming} />
              ))}
            </div>
          </div>
        </div>
